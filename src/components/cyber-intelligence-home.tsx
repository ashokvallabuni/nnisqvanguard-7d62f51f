...
const LEADERSHIP = [
  ...
  {
    name: "Pulijala Bhavani",
    title: "Chief Executive Officer",
    initials: "PB",
    color: "from-violet-400 to-purple-600",
    focus: ["Strategic Leadership", "Operations", "Business Development"],
  },
  {
    name: "Varun Gajula",
    title: "Co-Founder",
...
const AVAILABLE_COURSES = [
  {
    ...
    modules: 20,
    duration: "12 Hours",
    description: "CIA Triad, Kill Chain, Social Engineering, Cryptography, Firewalls, Zero Trust, SOC, Incident Response & Capstone.",
  ...
  },
  {
    ...
    modules: 10,
    duration: "6 Hours",
    description: "Network Fundamentals, OSI/TCP-IP, IP & Subnets, Packet Switching, DNS/HTTP/SSH, Firewalls, CLI Diagnostics.",
  ...
  },
  {
    ...
    modules: 7,
    duration: "5 Hours",
    description: "7 Skill Zones: Map Reading, Object Manipulation, Permissions, Log Forensics, Network Diagnostics, Process Warfare, Boss Battle.",
  ...
  },
  {
    ...
    modules: 52,
    duration: "24 Hours",
    description: "The complete 52-lesson beginner-to-analyst roadmap: Recon, OSINT, Exploitation, Web Security, Active Directory.",
...
// ─── Services ──────────────────────────────────────────────────────────────────
const SERVICES = [
  { icon: ShieldCheck, title: "Cybersecurity Consultation", body: "Strategic security advisory for organisations of all sizes — architecture reviews, threat modelling, and hardening roadmaps." },
  { icon: GraduationCap, title: "Security Awareness Training", body: "Transform your workforce into a human firewall with engaging, scenario-based cybersecurity awareness programs." },
  { icon: Building2, title: "College Awareness Programs", body: "Bringing cybersecurity education directly to campuses — practical labs, guest sessions, and career pathways." },
  { icon: Globe, title: "Enterprise Security Education", body: "Structured learning paths for enterprise teams — from SOC fundamentals to advanced threat hunting." },
  { icon: AlertTriangle, title: "Fraud Awareness", body: "Recognise, report and recover from digital fraud, phishing, and social engineering attacks before they succeed." },
  { icon: Heart, title: "Cyber Hygiene Programs", body: "Actionable daily habits, password management, device security, and safe browsing for individuals and families." },
] as const;

// ─── Community sections ────────────────────────────────────────────────────────
const COMMUNITY = [
  { icon: Users, title: "Digital Guardians", body: "Join a community of cyber defenders — shared threat intelligence, peer support, and mission-driven collaboration." },
  { icon: Building2, title: "College Programs", body: "We partner with universities across India to embed cybersecurity into campus culture and career pathways." },
  { icon: Zap, title: "Internships & Bounties", body: "Real-world security research opportunities, internship pipelines, and guided bug bounty programs for emerging talent." },
  { icon: Target, title: "Cybersecurity Events", body: "Capture-the-Flag competitions, workshops, and live tabletop exercises for colleges and corporate teams." },
] as const;
...
export function CyberIntelligenceHome() {
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#030712] text-slate-200">
        ...
        <div className="relative z-10 mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-12 px-5 py-20 sm:px-8 lg:grid-cols-12">
          <div className="space-y-7 lg:col-span-7">
            ...
            <p className="max-w-2xl font-mono text-sm leading-relaxed text-slate-300 sm:text-base">
              Enterprise-grade cybersecurity training, real data threat investigations, and hands-on cyber range labs — built by defenders for defenders.
            </p>
            ...
            <div className="intel-hud-border relative max-w-2xl border border-cyan-400/30 bg-slate-950/80 p-5">
              ...
              <p className="font-mono text-xs italic leading-relaxed text-cyan-100 sm:text-sm">
                "Security is not a product. It is a process built around people, signals and decisive action."
              </p>
              <p className="mt-2 font-mono text-[10px] text-slate-500">— Ashok Vallabhuni, Founder · Chief Architect, NISQ Vanguard</p>
            </div>
      ...
      <section id="founder" className="border-t border-slate-800 bg-gradient-to-b from-[#030712] to-slate-950 py-24">
          ...
          <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
            ...
            <div className="relative flex justify-center">
              ...
              <div className="relative inline-block">
                ...
                <div className="absolute -bottom-5 -right-5 z-20 flex h-16 w-16 items-center justify-center rounded-full border-2 border-cyan-400 bg-[#030712] shadow-[0_0_20px_rgba(0,210,255,0.4)]">
                  <img src={nisqLogo} alt="NISQ Vanguard emblem" className="h-11 w-11 rounded-full object-cover" />
                </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-2">
                {["Cyber Strategy", "AI · Security", "Cyber Defence Architecture", "Security Education", "College Outreach", "NISQ Vanguard Academy"].map((tag) => (
                  <span
                    key={tag}
              ...
              <p className="font-mono text-sm leading-relaxed text-slate-300">
                Ashok Vallabhuni is the Founder and Chief Architect of NISQ Vanguard Defence Technologies — an organisation dedicated to making cybersecurity education accessible, practical, and impactful across India and beyond. Through the IVVAB Labs engine, he architects real-world cyber ranges, structured course curriculums, and threat intelligence frameworks.
              </p>
      ...
      <section id="about-founder" className="border-t border-slate-800 bg-slate-950 py-24">
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          <div className="mb-12 text-center">
            <span className="font-mono text-[10px] tracking-[0.3em] text-cyan-400 uppercase">Why NISQ Vanguard Was Created</span>
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { icon: Shield, heading: "Cybersecurity Mission", body: "To democratise defensive cybersecurity knowledge and place it directly in the hands of students, professionals, and organisations across India." },
              { icon: Sparkles, heading: "Technology Vision", body: "Build AI-augmented threat intelligence tools and interactive cyber ranges that replicate real-world attack scenarios for authentic learning." },
              { icon: GraduationCap, heading: "Education Vision", body: "Structure clear, no-jargon learning pathways from absolute beginner to professional analyst — freely available and verifiably certified." },
              { icon: ShieldCheck, heading: "Cyber Protection", body: "Help individuals, colleges, and enterprises identify threats early, respond confidently, and build resilient digital postures." },
              { icon: Building2, heading: "College Outreach", body: "Embed cybersecurity thinking directly into campus culture through partnerships, workshops, internships and live CTF events." },
              { icon: Globe, heading: "Building an Ecosystem", body: "Create a thriving network of cyber defenders, researchers, and educators — the NISQ Vanguard community that grows stronger together." },
            ].map(({ icon: Icon, heading, body }) => (
              <div key={heading} className="border border-slate-700 bg-[#0a0f1d] p-6 hover:border-cyan-400/40 transition-colors">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
            {LEADERSHIP.map((member) => (
              ...
              >
                ...
                {/* Avatar */}
                <div className={`mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br ${member.color} font-display text-xl font-bold text-white shadow-lg`}>
                  {member.initials}
                </div>

                <h3 className="font-display text-xl font-bold text-white">{member.name}</h3>
                <p className="mt-1 font-mono text-[10px] tracking-widest text-cyan-400 uppercase">{member.title}</p>

                <div className="mt-4 flex flex-wrap justify-center gap-1.5">
                  {member.focus.map((f) => (
                    <span key={f} className="rounded-none border border-slate-600 bg-slate-800/60 px-2 py-0.5 font-mono text-[9px] text-slate-400">
                      {f}
                    </span>
                  ))}
                </div>
      ...
      <section id="about" className="border-t border-slate-800 bg-slate-950 py-24">
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              { icon: ShieldCheck, pillar: "PROTECTION", desc: "Proactive security consultation, threat detection, and incident support for individuals and organisations." },
              { icon: GraduationCap, pillar: "EDUCATION", desc: "Structured courses, live labs, and certifications that turn awareness into deployable capability." },
              { icon: Eye, pillar: "INTELLIGENCE", desc: "Real-data threat research, vulnerability advisories, and defensive intelligence for the defender community." },
              { icon: Users, pillar: "COMMUNITY", desc: "A thriving network of cyber defenders, students, researchers, and educators building India's cyber future." },
            ].map(({ icon: Icon, pillar, desc }) => (
              <div key={pillar} className="group border border-slate-700 bg-[#0a0f1d] p-8 text-center transition hover:border-cyan-400/60 hover:shadow-[0_0_24px_rgba(0,210,255,0.12)]">
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {SERVICES.map(({ icon: Icon, title, body }) => (
              <div key={title} className="group border border-slate-700 bg-[#0a0f1d] p-7 transition hover:border-cyan-400/60 hover:shadow-[0_0_20px_rgba(0,210,255,0.1)]">
      ...
      <section id="academy" className="border-t border-slate-800 bg-slate-950/90 py-24">
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          <div className="mb-14 text-center">
            <span className="font-mono text-[10px] tracking-[0.3em] text-cyan-400 uppercase">NISQ VANGUARD ACADEMY</span>
            ...
            <p className="mt-5 mx-auto max-w-2xl font-mono text-sm leading-relaxed text-slate-400">
              The NISQ Academy is the primary pillar of NISQ Vanguard — a structured, verifiable, hands-on cybersecurity education engine powered by the IVVAB Labs platform.
            </p>
          </div>

          <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
            {[
              { icon: BookOpen, label: "PATHWAY 01", title: "Structured Courses", to: "/learn", desc: "Canonical curriculums with real telemetry datasets and authoritative citations." },
              { icon: FlaskConical, label: "PATHWAY 02", title: "Guided Cyber Labs", to: "/cyber-range/labs", desc: "Containerised lab environments for hands-on skill application and CTF flags." },
              { icon: ChartNoAxesCombined, label: "PATHWAY 03", title: "Progress & Certificates", to: "/dashboard", desc: "Track learning milestones, earn skill badges, and receive verifiable certificates." },
      ...
      <section id="courses" className="border-t border-slate-800 bg-[#030712] py-24">
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            {AVAILABLE_COURSES.map(({ slug, title, level, modules, duration, description, skills, icon: Icon }) => (
              <div key={slug} className="group border border-slate-700 bg-[#0a0f1d] p-7 flex flex-col transition hover:border-cyan-400/60 hover:shadow-[0_0_24px_rgba(0,210,255,0.12)]">
                <div className="mb-5 flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    <span className="border border-slate-600 bg-slate-800 px-2 py-0.5 font-mono text-[9px] tracking-wider text-slate-400">{level}</span>
                    <span className="border border-slate-600 bg-slate-800 px-2 py-0.5 font-mono text-[9px] tracking-wider text-slate-400">{modules} modules</span>
                    <span className="border border-slate-600 bg-slate-800 px-2 py-0.5 font-mono text-[9px] tracking-wider text-slate-400">{duration}</span>
                  </div>
                </div>

                <h3 className="font-display text-xl font-bold text-white">{title}</h3>
                <p className="mt-2 flex-1 font-mono text-xs leading-relaxed text-slate-400">{description}</p>

                <div className="mt-4 flex flex-wrap gap-1.5">
                  {skills.map((s) => (
                    <span key={s} className="border border-slate-700 bg-slate-800/50 px-2 py-0.5 font-mono text-[9px] text-slate-500">{s}</span>
                  ))}
                </div>
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5">
            {LOCKED_COURSES.map(({ title, category }) => (
              ...
              >
                ...
                <div className="font-mono text-[8px] tracking-widest text-slate-600 mb-1">{category}</div>
                <div className="font-display text-xs font-semibold text-slate-400">{title}</div>
                <div className="mt-2 font-mono text-[8px] tracking-widest text-amber-500/70">COMING SOON</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="cyber-range" className="border-t border-slate-800 bg-[#030712] py-24">
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            <div>
              <span className="font-mono text-[10px] tracking-[0.3em] text-cyan-400 uppercase">Practical Training Infrastructure</span>
              ...
              <p className="mt-5 font-mono text-sm leading-relaxed text-slate-300">
                The NISQ Cyber Range provides isolated, containerised lab environments for hands-on practitioner training. Each lab scenario is built around real incident telemetry, adversary simulation, and defensive verification objectives.
              </p>

              <div className="mt-8 space-y-3">
                {[
                  { icon: Target, label: "Scenario-Based Labs", desc: "Real attack chains mapped to MITRE ATT&CK TTPs" },
                  { icon: ShieldCheck, label: "Verified Objectives", desc: "Complete tasks and capture verified flags" },
                  { icon: Terminal, label: "Live CLI Environments", desc: "Browser-based terminals for direct system interaction" },
                  { icon: ChartNoAxesCombined, label: "Progress Tracking", desc: "Track lab completions, scores, and skill growth" },
            ...
            <div className="intel-hud-border border border-cyan-400/40 bg-[#0a0f1d] p-6 shadow-[0_0_25px_rgba(0,210,255,0.12)]">
              <div className="mb-5 flex items-center justify-between border-b border-slate-700 pb-4 font-mono text-xs text-cyan-300">
                <span><Terminal className="mr-2 inline h-4 w-4" />VANGUARD_CYBER_RANGE.LOG</span>
              ...
              <div className="space-y-3 font-mono text-xs leading-relaxed text-slate-300">
                ...
                <p>&gt; loading lab: <span className="text-emerald-400">LAB-07 — Network Intrusion Detection</span></p>
                <p className="text-cyan-300">&gt; provisioning isolated subnet: 10.0.99.0/24</p>
                <p>&gt; deploying attacker node: <span className="text-red-400">192.168.1.105 [THREAT ACTOR]</span></p>
                <p>&gt; deploying defender node: <span className="text-emerald-400">10.0.99.5 [YOU]</span></p>
                <p className="text-amber-300">&gt; OBJECTIVE: Detect and block the SYN flood attack</p>
      ...
      <section id="intelligence" className="border-t border-slate-800 bg-slate-950 py-24">
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              { icon: Radar, label: "Threat Research", desc: "Emerging threat actor profiles, campaign tracking, and IOC feeds." },
              { icon: ShieldAlert, label: "Security Advisories", desc: "Timely vulnerability disclosures and recommended defensive postures." },
              { icon: Eye, label: "Vulnerability Tracking", desc: "CVE monitoring, patch prioritisation, and risk scoring dashboards." },
              { icon: Shield, label: "Defensive Guidance", desc: "Playbooks, mitigation strategies, and incident response templates." },
            ].map(({ icon: Icon, label, desc }) => (
              <div key={label} className="border border-slate-700 bg-[#0a0f1d] p-6 hover:border-cyan-400/40 transition-colors">
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {COMMUNITY.map(({ icon: Icon, title, body }) => (
              <div key={title} className="group border border-slate-700 bg-[#0a0f1d] p-7 transition hover:border-cyan-400/60">
                <div className="mb-5 flex h-11 w-11 items-center justify-center border border-cyan-400/30 bg-cyan-400/10 text-cyan-300 transition group-hover:bg-cyan-400 group-hover:text-slate-950">
                  <Icon className="h-5 w-5" />
                </div>
      ...
      <section className="border-t border-slate-800 bg-gradient-to-b from-slate-950 to-[#030712] py-24">
        <div className="mx-auto max-w-3xl px-5 text-center sm:px-8">
          <div className="mb-6 flex justify-center">
            <img src={nisqLogo} alt="NISQ Vanguard" className="h-14 w-14 rounded-full object-cover shadow-[0_0_32px_rgba(0,210,255,0.3)]" />
          </div>
          <h2 className="font-display text-4xl font-bold tracking-wide text-white sm:text-5xl">
          ...
          <p className="mt-5 font-mono text-sm leading-relaxed text-slate-400">
            Access the full NISQ Vanguard Academy, Cyber Range, and Threat Intelligence platform. Learning is free. Your defence starts now.
          </p>
          ...
          <div className="grid grid-cols-1 gap-10 sm:grid-cols-4">
            <div className="sm:col-span-1">
              <div className="flex items-center gap-3 mb-4">
                <img src={nisqLogo} alt="NISQ Vanguard" className="h-8 w-8 rounded-sm object-cover" />
                <span className="font-display text-xs font-bold tracking-widest text-white">NISQ VANGUARD</span>
              </div>
              <p className="font-mono text-[10px] leading-relaxed text-slate-500">
                Defence Technologies · Cyber Education · Threat Intelligence<br />
                Secure Today. Defend Tomorrow. Empower Forever.
              </p>
            </div>

            <div>
              <div className="font-mono text-[9px] tracking-[0.2em] text-cyan-400 mb-4 uppercase">Academy</div>
              <div className="space-y-2">
                {[["Courses", "/learn"], ["Cyber Range", "/cyber-range"], ["Learning Paths", "/cyber-range/learning-paths"], ["My Progress", "/dashboard"]].map(([label, to]) => (
                  <div key={label}><Link to={to as any} className="font-mono text-[10px] text-slate-500 hover:text-cyan-300 transition-colors">{label}</Link></div>
                ))}
              </div>
            </div>

            <div>
              <div className="font-mono text-[9px] tracking-[0.2em] text-cyan-400 mb-4 uppercase">Organisation</div>
              <div className="space-y-2">
                {[["About Founder", "/about/founder"], ["Campus Programs", "/programs"], ["Intelligence", "/intelligence"], ["Report Incident", "/complaint"]].map(([label, to]) => (
                  <div key={label}><Link to={to as any} className="font-mono text-[10px] text-slate-500 hover:text-cyan-300 transition-colors">{label}</Link></div>
                ))}
              </div>
            </div>
            ...
            <div>
              <div className="font-mono text-[9px] tracking-[0.2em] text-cyan-400 mb-4 uppercase">Legal</div>
              <div className="space-y-2">
                {[["Privacy Policy", "/privacy"], ["Terms of Service", "/terms"], ["Security", "/security"], ["Responsible Disclosure", "/responsible-disclosure"]].map(([label, to]) => (
                  <div key={label}><Link to={to as any} className="font-mono text-[10px] text-slate-500 hover:text-cyan-300 transition-colors">{label}</Link></div>
                ))}
              </div>
            </div>
...
function IntelStat({ value, label }: { value: string; label: string }) {
  return (
    <div>
      ...
      <div className="mt-1 font-mono text-[9px] uppercase tracking-widest text-cyan-300">{label}</div>
    </div>
  );
}
...
function SectionHeading({ eyebrow, title, body }: { eyebrow: string; title: string; body: string }) {
  return (
    <div className="mx-auto mb-14 max-w-3xl text-center">
      <span className="font-mono text-[10px] tracking-[0.3em] text-cyan-400 uppercase">{eyebrow}</span>
      <h2 className="mt-4 font-display text-3xl font-bold tracking-wide text-white sm:text-5xl">{title}</h2>
