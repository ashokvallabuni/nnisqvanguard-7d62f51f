...
function AccuracyBadge({ accuracy }: { accuracy: DataAccuracy }) {
  const styles: Record<DataAccuracy, string> = {
    LIVE: "bg-emerald-500/15 text-emerald-400 border-emerald-500/40 animate-pulse",
    RESEARCH: "bg-violet-500/15 text-violet-400 border-violet-500/40",
    STATIC: "bg-sky-500/15 text-sky-400 border-sky-500/40",
    "COMING SOON": "bg-amber-500/15 text-amber-400 border-amber-500/40",
  };
...
function severityBadgeClass(severity: string) {
  switch (severity.toLowerCase()) {
    ...
    case "medium":
      return "bg-amber-500/15 text-amber-400 border-amber-500/40 border";
    case "low":
      return "bg-emerald-500/15 text-emerald-400 border-emerald-500/40 border";
    case "info":
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 space-y-8">
            ...
            {THREAT_CATEGORIES.map((cat) => {
              ...
              return (
                ...
                >
                  ...
                  {isSoon && (
                    <span className="text-[0.6rem] font-mono px-1.5 py-0.5 rounded border border-amber-500/30 bg-amber-500/10 text-amber-400">
                      COMING SOON
                    </span>
                  )}
          ...
          <section className="lg:col-span-1 rounded-xl border border-border bg-card p-6 sm:p-8 space-y-5 shadow-xs">
            ...
            <div className="space-y-3">
              ...
              <div className="rounded-md border border-dashed border-border p-3 text-center">
                <p className="text-[0.65rem] font-mono font-bold text-amber-400 tracking-wider">
                  COMING SOON
                </p>
        ...
        <section className="rounded-xl border border-border bg-card p-6 sm:p-8 space-y-5 shadow-xs">
          ...
          <div className="rounded-md border border-dashed border-border p-4 text-center">
            ...
            <p className="text-[0.7rem] font-mono text-amber-400 tracking-wider font-bold">
            ...
            {RESEARCH_TOPICS.map((r, idx) => (
              ...
              >
                ...
                <div className="pt-2 border-t border-border/60 flex items-center justify-between">
                  ...
                  <button className="inline-flex items-center gap-1 text-[0.65rem] font-mono font-semibold px-2.5 py-1 rounded border border-border bg-background hover:bg-muted hover:border-violet-500/40 text-violet-400">
        ...
        <section className="rounded-xl border border-border bg-card p-6 sm:p-8 space-y-5 shadow-xs">
          ...
          <div className="rounded-md border border-dashed border-border p-4 text-center">
            ...
            <p className="text-[0.7rem] font-mono font-bold tracking-wider text-emerald-400">
