...
function ReportingFlow() {
  ...
  return (
    <main className="min-h-screen bg-[#070A0F] text-[#0A192F]">
      <PageHeader
      ...
      <div className="pb-12">
        <div className="max-w-3xl mx-auto px-4 md:px-8 mt-8">
          <div className="mb-6">
            {/* Steps Indicator */}
            {step < 4 && (
              <div className="flex items-center gap-2 font-mono text-[0.65rem] text-[#64748B]">
          ...
          <div className="glass backdrop-blur-xl bg-white border border-[#CBD5E1] shadow-sm rounded-2xl overflow-hidden transition-all duration-300">
            
            {step === 1 && (
              <div className="p-6 md:p-8 animate-in fade-in slide-in-from-right-4">
                <h2 className="text-xl font-bold mb-6 text-[#0A192F] font-display">What are you reporting today?</h2>
                    ...
                    <button
                      ...
                      className={`text-left p-5 rounded-xl border transition-all ${
                        form.incident_type === type.id 
                          ...
                          : 'border-[#CBD5E1] bg-[#F0F4F9]/50 hover:border-slate-600'
                      }`}
                    >
                      <div className={`font-semibold ${form.incident_type === type.id ? 'text-[#0284C7]' : 'text-[#0A192F]'}`}>
                        {type.title}
                      </div>
                      <div className="text-xs text-[#64748B] mt-1">{type.desc}</div>
                    </button>
                  ))}
                </div>
            ...
            {step === 2 && (
              <div className="p-6 md:p-8 animate-in fade-in slide-in-from-right-4">
                <h2 className="text-xl font-bold mb-2 text-[#0A192F] font-display">Incident Details</h2>
                <p className="text-[#64748B] text-sm mb-6">Please provide as much context as possible.</p>
                ...
                <div className="space-y-5">
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-[#F0F4F9]/50 border border-[#CBD5E1] rounded-lg px-4 py-3 text-sm text-[#0A192F] focus:outline-none focus:border-[#0284C7] focus:ring-1 focus:ring-[#0284C7] transition placeholder:text-slate-600"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-[#F0F4F9]/50 border border-[#CBD5E1] rounded-lg px-3 py-2.5 text-sm text-[#0A192F] file:mr-3 file:bg-[#F0F4F9] file:text-[#0A192F] file:border-0 file:px-3 file:py-1.5 file:rounded file:font-mono file:text-[0.7rem] file:font-semibold hover:file:bg-slate-700 transition"
                    />
                    <p className="mt-2 text-[0.65rem] text-[#64748B] font-mono">
                ...
                <div className="mt-8 flex justify-between">
                  <button onClick={handleBack} className="px-5 py-2.5 rounded-lg border border-[#CBD5E1] text-[#0A192F] font-semibold hover:bg-[#F0F4F9] transition-colors text-xs tracking-wider">
                    BACK
                  </button>
            ...
            {step === 3 && (
              <div className="p-6 md:p-8 animate-in fade-in slide-in-from-right-4">
                <h2 className="text-xl font-bold mb-2 text-[#0A192F] font-display">Contact Information</h2>
                <p className="text-[#64748B] text-sm mb-6">Leave blank to submit anonymously, or provide details for follow-up.</p>
                
                <div className="space-y-4">
                  <div>
                    <label className="font-mono text-[0.65rem] text-[#64748B] mb-2 block uppercase tracking-wider">Name (Optional)</label>
                    <input
                      type="text"
                      value={form.name}
                  ...
                  <div>
                    <label className="font-mono text-[0.65rem] text-[#64748B] mb-2 block uppercase tracking-wider">Email (Optional)</label>
                    <input
                      type="email"
                      value={form.email}
                  ...
                  <div>
                    <label className="font-mono text-[0.65rem] text-[#64748B] mb-2 block uppercase tracking-wider">Phone (Optional)</label>
                    <input
                      type="text"
                      value={form.phone}
                ...
                <div className="mt-8 flex justify-between">
                  <button onClick={handleBack} disabled={busy} className="px-5 py-2.5 rounded-lg border border-[#CBD5E1] text-[#0A192F] font-semibold hover:bg-[#F0F4F9] transition-colors text-xs tracking-wider">
                    BACK
                  </button>
            ...
            {step === 4 && (
              <div className="p-6 md:p-8 animate-in zoom-in-95 duration-500 text-center">
                ...
                <h2 className="text-2xl font-bold mb-2 text-[#0A192F] font-display">Report Submitted</h2>
                <p className="text-[#64748B] text-sm max-w-md mx-auto mb-6">
                  Your incident has been securely transmitted to our triage system.
                </p>
                
                <div className="bg-[#F0F4F9] border border-[#CBD5E1] rounded-xl p-4 max-w-sm mx-auto mb-8">
                  <div className="text-[0.65rem] text-[#64748B] font-mono uppercase tracking-widest mb-1">Generated Case ID</div>
                  <div className="text-xl font-mono font-bold text-[#0284C7] tracking-wider select-all">{caseId}</div>
                  <div className="text-[0.65rem] text-[#64748B] mt-2">Save this ID for your records and follow-ups.</div>
                </div>

                {/* First-Aid Resources */}
                <div className="text-left border-t border-[#CBD5E1]/60 pt-6">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div className="p-4 rounded-xl border border-[#CBD5E1] bg-[#F0F4F9]/50 flex gap-3">
                      <ShieldCheck className="w-5 h-5 text-[#0284C7] shrink-0" />
                      <div>
                        <div className="font-semibold text-[#0A192F] text-sm">Lock Accounts</div>
                        <div className="text-xs text-[#64748B] mt-1">Immediately change passwords and enable 2FA on compromised accounts.</div>
                      </div>
                    </div>
                    <div className="p-4 rounded-xl border border-[#CBD5E1] bg-[#F0F4F9]/50 flex gap-3">
                      <FileText className="w-5 h-5 text-[#0284C7] shrink-0" />
                      <div>
                        <div className="font-semibold text-[#0A192F] text-sm">Monitor Credit</div>
                        <div className="text-xs text-[#64748B] mt-1">Contact your bank and place a fraud alert on your credit profile.</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-8 flex justify-center gap-4">
                  <Link to="/" className="px-6 py-2.5 rounded-lg border border-[#CBD5E1] text-[#0A192F] font-semibold hover:bg-[#F0F4F9] transition-colors text-xs tracking-wider">
                    RETURN TO HOME
                  </Link>
                </div>
              </div>
