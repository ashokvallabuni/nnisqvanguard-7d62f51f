          ...
          <div className="glass backdrop-blur-xl bg-muted border border-border shadow-sm rounded-2xl overflow-hidden transition-all duration-300">
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-background/50 border border-border rounded-lg px-3 py-2.5 text-sm text-foreground file:mr-3 file:bg-background file:text-foreground file:border-0 file:px-3 file:py-1.5 file:rounded file:font-mono file:text-[0.7rem] file:font-semibold hover:file:bg-slate-700 transition"
                    />
            ...
            {step === 4 && (
              <div className="p-6 md:p-8 animate-in zoom-in-95 duration-500 text-center">
                ...
                {/* First-Aid Resources */}
                <div className="text-left border-t border-border/60 pt-6">
                  <h3 className="font-mono text-xs text-warning font-bold tracking-wider mb-4 flex items-center gap-2">
