...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CyberShield India — Cyber Awareness, Fraud Detection & College Outreach" },
      { name: "description", content: "AI-powered cyber fraud detection, complaint filing, and cybersecurity awareness programs for Indian colleges. Report scams instantly and book expert-led awareness sessions." },
      { name: "author", content: "CyberShield India" },
      { property: "og:title", content: "CyberShield India — Cyber Awareness & Fraud Detection Platform" },
      { property: "og:description", content: "AI-powered fraud detection and cyber awareness outreach for colleges across India." },
  ...
  return (
    <nav className="fixed top-0 inset-x-0 z-50 h-16 flex items-center justify-between px-4 md:px-8 glass border-b">
      <Link to="/" className="flex items-center gap-2">
        <div className="w-10 h-10 rounded-full bg-primary/10 border border-primary/40 flex items-center justify-center glow-cyber">
          <Shield className="w-5 h-5 text-cyber" />
        </div>
        <div className="leading-tight">
          <div className="display text-lg tracking-widest text-cyber">CYBERSHIELD</div>
          <div className="mono text-[0.55rem] text-muted-foreground">INDIA · GOV OUTREACH</div>
        </div>
      </Link>
