...
export const sqliInvestigationLab: LabDefinition = {
  ...
  description: "Investigate web access logs to trace an SQL Injection attack that extracted sensitive user data.",
  ...
  setupFilesystem: () => {
    ...
    let accessLog = "10.0.0.1 - - [25/Sep/2026:10:00:00 +0000] \"GET /index.php HTTP/1.1\" 200 1234\n";
    accessLog += "192.168.1.50 - - [25/Sep/2026:10:05:00 +0000] \"GET /product.php?id=1%27%20OR%201=1-- HTTP/1.1\" 200 5000\n";
    accessLog += "192.168.1.50 - - [25/Sep/2026:10:06:00 +0000] \"GET /product.php?id=1%20UNION%20SELECT%20username,password%20FROM%20users-- HTTP/1.1\" 200 9500\n";
