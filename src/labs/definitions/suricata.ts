...
export const suricataNidsLab: LabDefinition = {
  ...
  tasks: [
    ...
    },
    {
      ...
      validate: (ctx, cmd) =>
        cmd.includes("grep") && (cmd.includes("exfil") || cmd.includes("dns")),
    },
    {
      id: "t3",
