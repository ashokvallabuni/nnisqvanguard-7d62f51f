...
export const memoryForensicsLab: LabDefinition = {
  ...
  description: "Investigate memory artifacts from a compromised Windows workstation. Identify the malicious process and hidden connections. Note: This is a simulated offline environment of extracted Volatility 3 artifacts.",
  ...
  setupFilesystem: () => {
    ...
    vfs.writeFile("/evidence/pslist.txt", "PID   PPID  IMAGE_FILE_NAME\n4     0     System\n352   4     smss.exe\n544   536   csrss.exe\n600   536   wininit.exe\n656   592   csrss.exe\n696   600   services.exe\n712   600   lsass.exe\n3124  696   svchost.exe\n4092  3124  malware.exe\n");
    vfs.writeFile("/evidence/netscan.txt", "Proto  Local Address          Foreign Address        State       PID\nTCP    10.0.0.15:49152        192.168.1.100:4444     ESTABLISHED 4092\n");
