...
export const requireSupabaseAuth = createMiddleware({ type: 'function' }).server(
  async ({ next }) => {
    ...
    const SUPABASE_URL = process.env.SUPABASE_URL || (import.meta.env && import.meta.env.VITE_SUPABASE_URL);
    ...
    if (!data?.user) {
      console.error('[Supabase Auth Middleware] No user returned from getUser');
      throw new Error('Unauthorized: Invalid token');
    }
