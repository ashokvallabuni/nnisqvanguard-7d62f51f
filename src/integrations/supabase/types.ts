...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      ...
      incident_source: "ai_detection" | "user_report" | "threat_intel" | "system_alert" | "manual";
      incident_status: "new" | "analyzing" | "investigating" | "contained" | "resolved" | "closed";
      report_format: "markdown" | "json";
      report_type: "incident" | "threat_summary" | "weekly" | "monthly" | "custom";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
