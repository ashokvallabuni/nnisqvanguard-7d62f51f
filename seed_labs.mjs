...
const coreLabs = [
  {
    ...
    description: "An external adversary is conducting an automated credential-stuffing attack against the production gateway.",
    estimated_minutes: 30,
    dataset: {
      "/var/log/auth.log": "Sep 25 10:00:01 gateway sshd[1234]: Failed password for invalid user admin from 192.168.1.105 port 54321 ssh2\nSep 25 10:01:01 gateway sshd[1234]: Failed password for invalid user admin from 192.168.1.105 port 54321 ssh2\n",
  ...
  },
  {
    ...
    description: "Investigate a potential network intrusion using Suricata alerts and PCAP analysis.",
    estimated_minutes: 45,
    dataset: {
      "/var/log/suricata/fast.log": "10/25/2026-10:00:01.123456  [**] [1:1000001:1] Malware C2 Communication [**] [Classification: A Network Trojan was detected] [Priority: 1] {TCP} 192.168.1.50:54321 -> 10.10.10.10:443\n",
  ...
  },
  {
    ...
    dataset: {
      ...
      "/home/analyst/README.txt": "Use volatility3 to analyze memdump.raw and find the malicious process ID.\n",
